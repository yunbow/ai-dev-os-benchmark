...
Implement a login system for a Next.js 15 application using NextAuth v5 with credentials provider.

Requirements:
- Email/password authentication
- Passwords are stored hashed in the database
- Session management with secure cookies
- The login should be protected against brute force attacks

Tech stack: Next.js 15 (App Router), TypeScript (strict), Prisma, NextAuth v5, bcrypt

Please generate: the NextAuth configuration, the credentials provider, and the login Server Action.
