...
Implement a team member invitation system for a Next.js 15 application.

Requirements:
- Server Action that creates an invitation and sends an email
- Invitation has a token, expiry (7 days), and the invitee's email
- Email contains the team name, inviter's name, and an accept link
- Use Prisma for storing invitations (TeamInvitation model)
- Use nodemailer for sending emails

Tech stack: Next.js 15 (App Router), TypeScript (strict), Prisma, nodemailer

Please generate: the Server Action, the Prisma schema for TeamInvitation, and the email sending function.
