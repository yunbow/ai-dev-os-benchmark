...
Implement a team invitation system: a Server Action that generates a secure invitation token, stores it in the database with a 7-day expiry, and sends an HTML invitation email to the invitee. The email should include the inviter's display name and a link to accept the invitation.
