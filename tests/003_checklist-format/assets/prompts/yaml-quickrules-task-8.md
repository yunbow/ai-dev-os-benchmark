...
Design a Prisma schema for the task management application that includes User, Task, Team, and TeamMember models. Include a utility module for encrypting/decrypting sensitive user fields (e.g., email for export). Document the recommended database user privilege configuration.
