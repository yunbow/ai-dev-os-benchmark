...
# Curated Guidelines (Optimized 10 files — all fixes integrated)

> 10 files only (same count as Test 001). Fixes for V9, N7, T5, P4, S11, E4, E5, V3, N1, T4, AC2 integrated into existing files.
