Follow these performance guidelines when implementing:
...
Implement a task management dashboard page for a Next.js 15 App Router application.

Requirements:
- Server component page at app/(protected)/dashboard/page.tsx
- Shows summary stats (total tasks, completed, overdue)
- Includes a TaskList client component with filters and sorting
- Includes a CreateTaskDialog for adding new tasks (modal/dialog)
- Includes a TaskChart component showing task distribution by status (use recharts library)
- Includes a RichTextEditor component for task descriptions (heavy component)

Tech stack: Next.js 15 (App Router), TypeScript (strict), React, Tailwind CSS, recharts

Please generate the dashboard page and the component imports. Focus on how components are loaded and imported.
